...
class Menu:
    ...
    def desenhar_menu(self, opcoes, selecionado, titulo="", info=""):
        ...
        for i, opcao in enumerate(opcoes):
            ...
            rect = texto.get_rect(center=(screen_width / 2, 200 + i * 60))
    ...
    def mostrar_ranking(self):
        ...
        while executando:
            ...
            titulo_txt = self.font.render("TOP 3 RANKING", True, cor_menu_branco)
            titulo_rect = titulo_txt.get_rect(center=(screen_width // 2, 100))
            self.screen.blit(titulo_txt, titulo_rect)
    ...
    def mostrar_opcoes(self):
        opcoes = ["VOLUME MUSICA +", "VOLUME MUSICA -", "VOLUME EFEITOS +", "VOLUME EFEITOS -", "VOLTAR"]
        selecionado = 0
        executando = True
